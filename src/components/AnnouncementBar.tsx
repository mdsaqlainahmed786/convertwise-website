...
export function AnnouncementBar() {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center justify-center gap-x-2 px-10 sm:px-4 pr-10">
        <p className="text-center leading-none truncate sm:truncate-none">
          <span className="text-white/60 hidden sm:inline">ConvertWise is now </span>
          ...
          >
            <span className="hidden sm:inline">The story behind the name</span>
