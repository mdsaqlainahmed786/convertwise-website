    ...
    <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-amber-50 dark:from-amber-900/20 via-white dark:via-gray-900 to-orange-50 dark:to-orange-900/20 transition-colors">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          {/* Left content — static */}
          <div>
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-white/95 dark:bg-[#E89422]/10 border border-[#E89422]/30 dark:border-[#E89422]/30 rounded-full shadow-lg transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button
                ...
                className="px-8 py-4 bg-white/95 dark:bg-white/[0.06] border-2 border-gray-900 dark:border-white/20 text-gray-900 dark:text-gray-100 rounded-full hover:bg-gray-900 dark:hover:bg-white/10 hover:text-white dark:hover:text-white transition-colors flex cursor-pointer items-center justify-center gap-2 shadow-lg"
            ...
            <div className="bg-white/95 dark:bg-white/[0.04] border border-white/80 dark:border-white/[0.08] rounded-2xl p-6 shadow-lg transition-colors">
          ...
          <div className="relative">
            <div className="relative bg-white/95 dark:bg-white/[0.04] rounded-3xl shadow-2xl border border-white/80 dark:border-white/[0.08] overflow-hidden transition-colors">
              <div className="bg-gradient-to-r from-[#E89422]/90 to-[#963C00]/90 p-6 text-white border-b border-white/20">
              ...
              <div className="p-6 space-y-4" style={{ paddingBottom: '3.5rem' }}>
                <div className="bg-gradient-to-br from-amber-50/80 dark:from-[#E89422]/10 to-orange-50/5 dark:to-orange-900/10 p-5 rounded-2xl border border-amber-100/60 dark:border-white/[0.08] transition-colors">
                  ...
                  <div className="h-3 bg-white/50 dark:bg-white/[0.08] rounded-full overflow-hidden border border-white/60 dark:border-white/[0.06]">
                    <div className="h-full w-[87%] bg-gradient-to-r from-[#E89422] to-[#963C00] rounded-full" />
                  </div>
                </div>

                <div className="space-y-2.5">
                  <div className="flex items-center gap-3 p-3.5 bg-green-50/80 dark:bg-green-900/20 border border-green-200/60 dark:border-green-700/40 rounded-xl transition-colors">
                    <div className="w-2 h-2 bg-green-500 dark:bg-green-400 rounded-full flex-shrink-0" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Perfect moment detected to discuss pricing</span>
                  </div>
                  <div className="flex items-center gap-3 p-3.5 bg-blue-50/80 dark:bg-blue-900/20 border border-blue-200/60 dark:border-blue-700/40 rounded-xl transition-colors">
                  ...
                  <div className="flex items-center gap-3 p-3.5 bg-amber-50/80 dark:bg-[#E89422]/10 border border-amber-200/60 dark:border-[#E89422]/30 rounded-xl transition-colors">
                    <div className="w-2 h-2 bg-[#E89422] rounded-full flex-shrink-0" />
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[{ emoji: '😊', label: 'Positive' }, { emoji: '🤔', label: 'Curious' }, { emoji: '👍', label: 'Engaged' }].map((item, i) => (
                    <div
                      key={i}
                      className="text-center p-3.5 bg-white/95 dark:bg-white/[0.04] rounded-xl border border-white/70 dark:border-white/[0.08] shadow-sm transition-colors"
                    >
            ...
            <div className="absolute -bottom-6 -left-6 bg-white/95 dark:bg-gray-900/90 p-5 rounded-2xl shadow-xl border border-white/80 dark:border-white/[0.08] transition-colors">
            ...
            <div className="absolute -top-6 -right-6 bg-white/95 dark:bg-gray-900/90 p-5 rounded-2xl shadow-xl border border-white/80 dark:border-white/[0.08] transition-colors">
