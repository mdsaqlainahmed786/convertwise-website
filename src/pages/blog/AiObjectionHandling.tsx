  ...
  return (
    <>
      ...
      >
        ...
        <p>Nimitai's pre-call preparation agent includes likely objection patterns for each prospect based on their industry, company size, and previous interactions — so reps can proactively address the three most probable objections before they appear, not after.</p>

        <RelatedArticles links={[
          { to: '/blog/real-time-sales-coaching-ai', label: 'Real-Time AI Coaching: Why Post-Call Review Is Too Late' },
          { to: '/blog/buyer-intent-signals-sales-calls', label: 'How to Detect Buyer Intent Signals in Sales Calls' },
          { to: '/blog/how-to-increase-close-rate', label: 'How to Increase Close Rate: 9 Strategies from 350+ Calls' },
          { to: '/blog/b2b-saas-demo-best-practices', label: '12 B2B SaaS Demo Tactics That Convert' },
        ]} />
      </BlogShell>
    </>
  );
