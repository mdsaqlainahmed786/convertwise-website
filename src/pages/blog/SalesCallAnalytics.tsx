  ...
  return (
    <>
      ...
      >
        ...
        <p>The metrics below are drawn from our analysis of 350+ real B2B sales calls — comparing calls from deals that closed against calls from deals that didn't, across teams selling SaaS, MedTech, and professional services.</p>
        ...
        <p><Link to="/blog/conversation-intelligence-guide">Conversation intelligence software</Link> that tracks these metrics automatically changes the economics. Nimitai surfaces all 7 metrics automatically from every call — giving sales managers a coaching dashboard without requiring them to listen to recordings.</p>
        <p>The goal isn't to surveille your team. It's to give managers the pattern visibility they need to coach on the right things — the specific behaviors that actually predict revenue — instead of coaching on volume and activity metrics that don't.</p>
